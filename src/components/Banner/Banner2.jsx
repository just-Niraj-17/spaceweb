...
import satelight2 from "../../assets/satelite2.jpg"
  ...
  return (
    ...
    <div className="bg-black text-white  pb-12 relative z-50">
        <div className="container ml-14">
            ...
            <div className='space-y-3 xl:pl-36 p-4 border-l-2 border-b-2 border-l-sky-800 border-b-sky-800 ml-3'>
            ...
            <div data-aos="zoom-in">
                <img data-aos="fade-up"  data-aos-delay="300" src={satelight2} alt="" className="w-full sm:w-[80%] mx-auto max-h-[350px] object-cover"/>
            </div>
